...
GL_VAO gl_create_vertex_array(u8 attrib_count);
void gl_bind_vertex_array(GL_VAO *vao);
void gl_unbind_vertex_array();
void gl_set_vertex_attribute(GL_VAO *vao, GLenum data_type, u32 count);
